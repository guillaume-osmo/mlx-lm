...
| SmolLM | `mlx-community/SmolLM3-3B-4bit` | `2048` prompt / `16` decode | `mse`, `4-bit` | `93.45` | `81.07` | `162.0 -> 45.39` | `16/16` | native is still faster, but the memory cut is strong and exact |

**Other exact reference results**
